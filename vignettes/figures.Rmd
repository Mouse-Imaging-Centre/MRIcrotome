...
The best way to use MRIcrotome is through pipes; the pipe comes from _purrr_, which MRIcrotome already depends on (the full tidyverse works just as well). Also, the graphics subsystem is _grid_ graphics, so let's go ahead and load that as well.
