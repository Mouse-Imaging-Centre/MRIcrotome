...
#' @param col The colour scale. Defaults to \code{\link{defaultCol}()} (red-yellow
#'   ramp, configurable via \code{options("MRIcrotomeCol")}).
...
#'   \code{\link{defaultRCol}()} (blue-turquoise ramp, configurable via
#'   \code{options("MRIcrotomeRcol")}).
#' @param alpha Value between 0 and 1, 0 being full transparent and 1 fully opaque.
